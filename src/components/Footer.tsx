...
const Footer = () => {
  return (
    <footer className="bg-kerma-brown text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="text-gray-300 hover:text-kerma-blue transition-colors"
                aria-label="LinkedIn"
              >
        ...
        <div className="border-t border-gray-600 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <Link to="/politique-confidentialite" className="text-sm text-gray-300 hover:text-white transition-colors">
