...
const SEO = ({
  ...
  description = 'Découvrez nos programmes immobiliers d\'exception à Dakar. KĒRMA Developments crée des espaces de vie pensés pour votre confort et votre avenir.',
  keywords = 'immobilier, Dakar, Sénégal, promotion immobilière, appartements, investissement',
  image = '/uploads/8a248a4e-db11-46c5-aa58-42e802640f3c.png',
